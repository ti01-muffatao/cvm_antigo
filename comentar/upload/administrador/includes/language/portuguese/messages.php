...
define('CMTX_MSG_COMMENT_BULK_DELETED', '1 Comentário deletado.');
define('CMTX_MSG_COMMENTS_BULK_DELETED', '%d comentário deletado.');
define('CMTX_MSG_COMMENT_APPROVED', 'Comentário aprovado.');
define('CMTX_MSG_COMMENT_BULK_APPROVED', '1 comentário aprovado.');
define('CMTX_MSG_COMMENTS_BULK_APPROVED', '%d comentário aprovad.');
