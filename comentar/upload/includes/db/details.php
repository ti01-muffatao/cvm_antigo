...
$cmtx_mysql_database = 'portalmu_comentar';				// The name of the database you created
$cmtx_mysql_username = 'portalmu_bi'; 				// Your MySQL username
$cmtx_mysql_password = '125030';			 	// Your MySQL password
