...
cmtx_define('CMTX_OPEN_FORM_TITLE', 'Clique para abrir o formulário');
...
cmtx_define('CMTX_REPLY_CANCEL_TITLE', 'Cancelar esta resposta');
cmtx_define('CMTX_REPLY_NOBODY', 'Você não está respondendo para ninguém.');

/* Required */
cmtx_define('CMTX_REQUIRED_SYMBOL', '*');
cmtx_define('CMTX_REQUIRED_SYMBOL_MESSAGE', CMTX_REQUIRED_SYMBOL . ' Campos Obrigatórios');
...
/* BB Code titles */
cmtx_define('CMTX_BB_CODE_TITLE_BOLD', 'Negrigo');
cmtx_define('CMTX_BB_CODE_TITLE_ITALIC', 'Italico');
cmtx_define('CMTX_BB_CODE_TITLE_UNDERLINE', 'Sublinhado');
...
/* Smiley titles */
cmtx_define('CMTX_SMILEY_TITLE_SMILE', 'Sorriso');
cmtx_define('CMTX_SMILEY_TITLE_SAD', 'Triste');
cmtx_define('CMTX_SMILEY_TITLE_HUH', 'Huh');
cmtx_define('CMTX_SMILEY_TITLE_LAUGH', 'Risada');
cmtx_define('CMTX_SMILEY_TITLE_MAD', 'Louco');
cmtx_define('CMTX_SMILEY_TITLE_TONGUE', 'Língua');
cmtx_define('CMTX_SMILEY_TITLE_CRYING', 'Choro');
cmtx_define('CMTX_SMILEY_TITLE_GRIN', 'Sorriso largo');
cmtx_define('CMTX_SMILEY_TITLE_WINK', 'Wink');
cmtx_define('CMTX_SMILEY_TITLE_SCARED', 'Assustado');
cmtx_define('CMTX_SMILEY_TITLE_COOL', 'Legal ');
cmtx_define('CMTX_SMILEY_TITLE_SLEEP', 'Sono ');
cmtx_define('CMTX_SMILEY_TITLE_BLUSH', 'Corar');
cmtx_define('CMTX_SMILEY_TITLE_UNSURE', 'Inseguro');
cmtx_define('CMTX_SMILEY_TITLE_SHOCKED', 'Chocado');

/* Text displayed for BB Code bullet dialog */
cmtx_define('CMTX_BULLET_DIALOG_HEADING', 'Inserir lista');
cmtx_define('CMTX_BULLET_DIALOG_CONTENT_1', 'Por favor, insira pelo menos um item.');
cmtx_define('CMTX_BULLET_DIALOG_CONTENT_2', 'Item:');
cmtx_define('CMTX_BULLET_DIALOG_INSERT', 'Inserir');
cmtx_define('CMTX_BULLET_DIALOG_CANCEL', 'Cancelar');

/* Text displayed for BB Code numeric dialog */
cmtx_define('CMTX_NUMERIC_DIALOG_HEADING', 'Insira lista numérica');
cmtx_define('CMTX_NUMERIC_DIALOG_CONTENT_1', 'Por favor, insira pelo menos um item.');
cmtx_define('CMTX_NUMERIC_DIALOG_CONTENT_2', 'Item:');
cmtx_define('CMTX_NUMERIC_DIALOG_INSERT', 'Inserir');
cmtx_define('CMTX_NUMERIC_DIALOG_CANCEL', 'Cancelar');
...
cmtx_define('CMTX_EMAIL_DIALOG_HEADING', 'Inserir Email');
cmtx_define('CMTX_EMAIL_DIALOG_CONTENT_1', 'Por favor insira o endereço de e-mail');
cmtx_define('CMTX_EMAIL_DIALOG_CONTENT_2', 'Opcionalmente, adicione qualquer texto de exibição');
cmtx_define('CMTX_EMAIL_DIALOG_INSERT', 'Inserir');
cmtx_define('CMTX_EMAIL_DIALOG_CANCEL', 'Cancelar');

/* Text displayed for BB Code image dialog */
cmtx_define('CMTX_IMAGE_DIALOG_HEADING', 'Inserir Imagem');
cmtx_define('CMTX_IMAGE_DIALOG_CONTENT', 'Por favor, indique o link da imagem');
cmtx_define('CMTX_IMAGE_DIALOG_INSERT', 'Inserir');
cmtx_define('CMTX_IMAGE_DIALOG_CANCEL', 'Cancelar');
