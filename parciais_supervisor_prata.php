...
<head>
	...
	<title>22ª Campanha de Verão Muffatão</title>
	<!-- Favicon -->
	...
	<div class="section_holdergrupos">
		<div class="one_full">
			<div style="padding-left: 5%">
				<h3>Bingo Mix Estrela - Supervisores</h3>
							...
							<div class="table-style">
								<table class="table-list2">
									<tr class="sticky">
										...
										<th>NOME</th>
										<?php
										$RSS = mysql_query("select * from clifor_prata", $conexao);
									...
									<tr>
										<?php
										$SQLG = "select * from usuarios where cd_perfil = 3 and cd_ativo = 1 order by cd_codigo asc ";
										// echo $SQLG;
										...
										?>
											...
											<?php for ($k = 1; $k <= $i; $k++) {
												...
												$SQL = "select * from metas_bingo_prata_sup where cd_codigo = '" . $RSG['cd_codigo'] . "' and cd_fornecedor = '" . $forne[$k] . "' and cd_mes = " . substr($data_min, 4, 2) . "";
											...
											?>
														...
														<td>
															<table>
																<tr>
																	<td width="100%"><strong>Meta: </strong><br><?= number_format($meta, 2, ",", "."); ?></td>
