  ...
  <div class="container"></div>
    ...
    <div class="portfolio_four">       
      <div class="container" style="min-height: 500px;">
        ...
        <?php            
            $codigo_vendedor = $_GET['codigo']; 
            $query = mysql_query("select dt_inicial, dt_final, cd_fornecedor, cd_produto, sum(cd_pontos) pontos from pontuacao_aceleradores where cd_codigo = '".$codigo_vendedor."' group by cd_fornecedor, cd_produto");
            ...
            ?>
                <tr>
                  ...
                  <td><?php
                          $data_inicial = explode("-",$acelerador['dt_inicial']);
                          $data_final = explode("-",$acelerador['dt_final']);
