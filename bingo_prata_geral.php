...
if($_SESSION["CD_USUARIO"] == "" || !in_array($_SESSION['CD_CODIGO'], array('6000','6001','6002','6003','6004'))){
          ...
          <div id="grupo-1" class="tabs-panel7">
            ...
            <table class="table-list2">
                ...
                <?php
					...
					$dsCartelas		= "0";
					$cartExtra 		= 0;
					$dias_uteis 	= dias_uteis(11,2022);
					
					if(date('m') != 11){
						$dias_passaram = dias_uteis(11,2022);
					}else{
						$dias_passaram 	= dias_passaram(11,2022);
					}
					
					$dias_real 		= ($dias_passaram / $dias_uteis) * 100;
					
					//echo "uteis ".$dias_uteis."<br>passaram ".$dias_passaram;
					$RSS = mysql_query("SELECT * from metas_bingo_prata_geral where cd_mes = 11 and cd_ano = 2020 order by vl_meta asc ",$conexao);
          ...
          <div id="grupo-2" class="tabs-panel7">
            ...
            <table class="table-list2">
                ...
                <?php
					...
					$dsCartelas		= "0";
					$cartExtra 		= 0;
					$dias_uteis 	= dias_uteis(12,2022);
					
					if(date('m') != 12){
						$dias_passaram = dias_uteis(12,2022);
					}else{
						$dias_passaram 	= dias_passaram(12,2022);
					}
					
					$dias_real 		= ($dias_passaram / $dias_uteis) * 100;
					
					//echo "uteis ".$dias_uteis."<br>passaram ".$dias_passaram;
					$RSS = mysql_query("select * from metas_bingo_prata_geral where cd_mes = 12 and cd_ano = 2020 order by vl_meta asc ",$conexao);
					while($RS = mysql_fetch_array($RSS)){
					// extras bingo
					$sumMeta += $RS['vl_meta'];
          ...
          <div id="grupo-3" class="tabs-panel7">
            ...
            <table class="table-list2">
                ...
                <?php
					...
					$dsCartelas		= "0";
					$cartExtra 		= 0;
					$dias_uteis 	= dias_uteis(01,2023);
					if(date('m') != 01){
						$dias_passaram = dias_uteis(01,2023);
					}else{
						$dias_passaram 	= dias_passaram(01,2023);
					}
					$dias_real 		= ($dias_passaram / $dias_uteis) * 100;
					
					//echo "uteis ".$dias_uteis."<br>passaram ".$dias_passaram;
					$RSS = mysql_query("SELECT * from metas_bingo_prata_geral where cd_mes = 01 and cd_ano = 2022 order by vl_meta asc ",$conexao);
					while($RS = mysql_fetch_array($RSS)){
					// extras bingo
					$sumMeta += $RS['vl_meta'];
          ...
          <div id="grupo-4" class="tabs-panel7">
            ...
            <table class="table-list2">
                ...
                <?php
					...
					$dsCartelas		= "0";
					$cartExtra 		= 0;
					$dias_uteis 	= dias_uteis(02,2023);
					
					if(date('m') != 02){
						$dias_passaram = dias_uteis(02,2023);
					}else{
						$dias_passaram 	= dias_passaram(02,2023);
					}
					
					$dias_real 		= ($dias_passaram / $dias_uteis) * 100;
					
					//echo "uteis ".$dias_uteis."<br>passaram ".$dias_passaram;
					$RSS = mysql_query("select * from metas_bingo_prata_geral where cd_mes = 02 and cd_ano = 2022 order by vl_meta asc ",$conexao);
					while($RS = mysql_fetch_array($RSS)){
					// extras bingo
					$sumMeta += $RS['vl_meta'];
