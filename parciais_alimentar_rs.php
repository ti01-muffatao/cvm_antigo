    ...
    <div class="container">
      <div class="one_full">
        <!-- NOTIFICAÇÃO
		 ...
		 NOTIFICAÇÃO -->
        <h3>Parciais Rio Grande do Sul até
...
<font color="#C30009"><a onMouseOver="toolTip('<b>DATA DA ÚLTIMA PARCIAL')" onMouseOut="toolTip()" animatescroll();"><?php echo date("d-m-Y", strtotime($RS["data"])-1);}?></a></font></h3>
        ...
        <!-- INICIO GRUPO 1 -->
          <div id="grupo-1" class="tabs-panel7">
            <p>
             <?php $RSS = mysql_query("select * from grupos where cd_grupo = 13 order by cd_grupo asc", $conexao);
		   while($RS = mysql_fetch_array($RSS)){?>
            <h3>Grupo 01</h3>
            <?php
			echo "<h5>Meta Mínima: ".$RS["vl_metam"]."</h5>";
			echo "<h5>Meta Geral: ".$RS["vl_metag"]."</h5>";
			$metageralgrupo13 = $RS["vl_metag"];
         ...
         <table class="table-list2">
			...
			<?php $SQL = "select u.ds_usuario, p.cd_codigo, u.cd_grupo, sum(p.cd_pontos) as pontos from pontuacao as p, usuarios as u where p.cd_codigo = u.cd_codigo and u.cd_perfil = 4 and u.cd_ativo = 1 and u.cd_mostrar = 1 and u.cd_grupo = 13 and p.dt_data = (select dt_data from pontuacao order by dt_data desc limit 1) ";
            ...
            <tr>
              ...
              <?php for($w = 1; $w <= $i; $w++){
				...
				$SQW .= " and p.cd_fornecedor = '".$forne[$w]."' and u.cd_grupo = 13 and u.cd_ativo = 1 and u.cd_mostrar = 1 ";
          ...
          <div id="grupo-2" class="tabs-panel7">
            <p>
            <?php $RSS = mysql_query("select * from grupos where cd_grupo = 14 order by cd_grupo asc", $conexao);
		   while($RS = mysql_fetch_array($RSS)){?>
            <h3>Grupo 02</h3>
            <?php
			echo "<h5>Meta Mínima: ".$RS["vl_metam"]."</h5>";
			echo "<h5>Meta Geral: ".$RS["vl_metag"]."</h5>";
			$metageralgrupo14 = $RS["vl_metag"];
			$metaminima = $RS["vl_metam"];
		   }?>
            <div class="table-style">
         <table class="table-list2">
			...
			<?php $SQL = "select u.ds_usuario, p.cd_codigo, u.cd_grupo, sum(p.cd_pontos) as pontos from pontuacao as p, usuarios as u where p.cd_codigo = u.cd_codigo and u.cd_perfil = 4 and u.cd_ativo = 1 and u.cd_mostrar = 1 and u.cd_grupo = 14 and p.dt_data = (select dt_data from pontuacao order by dt_data desc limit 1) ";
			$SQL .= " group by u.ds_usuario, p.cd_codigo order by pontos desc";
			$RSS = mysql_query($SQL, $conexao);
			while($RS = mysql_fetch_array($RSS)){
				$x = $x + 1;
            ...
            <tr>
              ...
              <?php for($w = 1; $w <= $i; $w++){
				$SQW = "select sum(p.cd_pontos) as pts, u.cd_codigo from pontuacao as p, usuarios as u where p.cd_codigo = u.cd_codigo and p.dt_data = (select dt_data from pontuacao order by dt_data desc limit 1) ";
				$SQW .= " and p.cd_fornecedor = '".$forne[$w]."' and u.cd_grupo = 14 and u.cd_ativo = 1 and u.cd_mostrar = 1 ";
				$RQW = mysql_query($SQW, $conexao);
				$RW = mysql_fetch_assoc($RQW);
				echo "<th>".number_format(round($RW["pts"]), 0, '', '.')."</th>";
			  }?>
          ...
          <div id="grupo-3" class="tabs-panel7">
            <p>
            <?php $RSS = mysql_query("select * from grupos where cd_grupo = 15 order by cd_grupo asc", $conexao);
		   while($RS = mysql_fetch_array($RSS)){?>
            <h3>Grupo 03</h3>
            <?php
			echo "<h5>Meta Mínima: ".$RS["vl_metam"]."</h5>";
			echo "<h5>Meta Geral: ".$RS["vl_metag"]."</h5>";
			$metageralgrupo15 = $RS["vl_metag"];
			$metaminima = $RS["vl_metam"];
		   }?>
            <div class="table-style">
         <table class="table-list2">
			...
			<?php $SQL = "select u.ds_usuario, p.cd_codigo, u.cd_grupo, sum(p.cd_pontos) as pontos from pontuacao as p, usuarios as u where p.cd_codigo = u.cd_codigo and u.cd_perfil = 4 and u.cd_ativo = 1 and u.cd_mostrar = 1 and u.cd_grupo = 15 and p.dt_data = (select dt_data from pontuacao order by dt_data desc limit 1) ";
			$SQL .= " group by u.ds_usuario, p.cd_codigo order by pontos desc";
			$RSS = mysql_query($SQL, $conexao);
			while($RS = mysql_fetch_array($RSS)){
				$x = $x + 1;
            ...
            <tr>
              ...
              <?php for($w = 1; $w <= $i; $w++){
				$SQW = "select sum(p.cd_pontos) as pts, u.cd_codigo from pontuacao as p, usuarios as u where p.cd_codigo = u.cd_codigo and p.dt_data = (select dt_data from pontuacao order by dt_data desc limit 1) ";
				$SQW .= " and p.cd_fornecedor = '".$forne[$w]."' and u.cd_grupo = 15 and u.cd_ativo = 1 and u.cd_mostrar = 1 ";
				$RQW = mysql_query($SQW, $conexao);
				$RW = mysql_fetch_assoc($RQW);
				echo "<th>".number_format(round($RW["pts"]), 0, '', '.')."</th>";
			  }?>
          ...
          <div id="grupo-4" class="tabs-panel7">
            <p>
            <?php $RSS = mysql_query("select * from grupos where cd_grupo = 16 order by cd_grupo asc", $conexao);
		   while($RS = mysql_fetch_array($RSS)){?>
            <h3>Grupo 04</h3>
            <?php
			echo "<h5>Meta Mínima: ".$RS["vl_metam"]."</h5>";
			echo "<h5>Meta Geral: ".$RS["vl_metag"]."</h5>";
			$metageralgrupo16 = $RS["vl_metag"];
			$metaminima = $RS["vl_metam"];
		   }?>
            <div class="table-style">
         <table class="table-list2">
			...
			<?php $SQL = "select u.ds_usuario, p.cd_codigo, u.cd_grupo, sum(p.cd_pontos) as pontos from pontuacao as p, usuarios as u where p.cd_codigo = u.cd_codigo and u.cd_perfil = 4 and u.cd_ativo = 1 and u.cd_mostrar = 1 and u.cd_grupo = 16 and p.dt_data = (select dt_data from pontuacao order by dt_data desc limit 1) ";
			$SQL .= " group by u.ds_usuario, p.cd_codigo order by pontos desc";
			$RSS = mysql_query($SQL, $conexao);
			while($RS = mysql_fetch_array($RSS)){
				$x = $x + 1;
            ...
            <tr>
              ...
              <?php for($w = 1; $w <= $i; $w++){
				$SQW = "select sum(p.cd_pontos) as pts, u.cd_codigo from pontuacao as p, usuarios as u where p.cd_codigo = u.cd_codigo and p.dt_data = (select dt_data from pontuacao order by dt_data desc limit 1) ";
				$SQW .= " and p.cd_fornecedor = '".$forne[$w]."' and u.cd_grupo = 16 and u.cd_ativo = 1 and u.cd_mostrar = 1 ";
				$RQW = mysql_query($SQW, $conexao);
				$RW = mysql_fetch_assoc($RQW);
				echo "<th>".number_format(round($RW["pts"]), 0, '', '.')."</th>";
			  }?>
          ...
          <div id="grupo-5" class="tabs-panel7">
            <p>
            <?php $RSS = mysql_query("select * from grupos where cd_grupo = 17 order by cd_grupo asc", $conexao);
		   while($RS = mysql_fetch_array($RSS)){?>
            <h3>Grupo 05</h3>
           <?php
			echo "<h5>Meta Mínima: ".$RS["vl_metam"]."</h5>";
			echo "<h5>Meta Geral: ".$RS["vl_metag"]."</h5>";
			$metageralgrupo17 = $RS["vl_metag"];
			$metaminima = $RS["vl_metam"];
		   }?>
            <div class="table-style">
         <table class="table-list2">
			...
			<?php $SQL = "select u.ds_usuario, p.cd_codigo, u.cd_grupo, sum(p.cd_pontos) as pontos from pontuacao as p, usuarios as u where p.cd_codigo = u.cd_codigo and u.cd_perfil = 4 and u.cd_ativo = 1 and u.cd_mostrar = 1 and u.cd_grupo = 17 and p.dt_data = (select dt_data from pontuacao order by dt_data desc limit 1) ";
			$SQL .= " group by u.ds_usuario, p.cd_codigo order by pontos desc";
			$RSS = mysql_query($SQL, $conexao);
			while($RS = mysql_fetch_array($RSS)){
				$x = $x + 1;
            ...
            <tr>
              ...
              <?php for($w = 1; $w <= $i; $w++){
				$SQW = "select sum(p.cd_pontos) as pts, u.cd_codigo from pontuacao as p, usuarios as u where p.cd_codigo = u.cd_codigo and p.dt_data = (select dt_data from pontuacao order by dt_data desc limit 1) ";
				$SQW .= " and p.cd_fornecedor = '".$forne[$w]."' and u.cd_grupo = 17 and u.cd_ativo = 1 and u.cd_mostrar = 1 ";
				$RQW = mysql_query($SQW, $conexao);
				$RW = mysql_fetch_assoc($RQW);
				echo "<th>".number_format(round($RW["pts"]), 0, '', '.')."</th>";
			  }?>
