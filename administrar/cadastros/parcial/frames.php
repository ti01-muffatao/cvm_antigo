...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:verdana; font-size:11px;">
  <tr> 
	...
	<b>Pesquisar por Data:</b>
	<input type="text" id="TxPesquisa" name="TxPesquisa" OnKeyPress="Formata(this, '##/##/####')" onKeyUp="javascript: window.frames['Lista'].recarrega(document.getElementById('TxPesquisa').value);" class="selectboxnormal" size="30" value="" maxlength="10">
	</td>
