...
//----------------------------------------------------------------------------------------------------
	...
	this.textColor = "#FFF";			// text color
	this.textAlign = "center";			// text alignment: "left", "right" or "center"
	this.border = "10px solid #000";	// border (CSS spec: size style color, e.g. "1px solid #D00000")
	this.padding = 1;					// padding (pixels)
	this.opacity = 90;					// opacity (1 - 100); not supported by all browsers
	this.cursorDistance = 3;			// distance from mouse cursor (pixels)
