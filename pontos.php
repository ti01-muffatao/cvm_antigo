...
<body>
    ...
    <div class="container">
        <div style="margin-top: 80px">
            <div class="container" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="container" style="display: flex; justify-content: space-between; align-items: center;">
                    <h3>Pontuações de produtos</h3>

                    <div style="display: flex; align-items: center; gap: 15px;">
                        <h5>
                            Clique <a href="download/pontuacao.xlsx" style="color: green; text-decoration: underline;">aqui</a> para baixar a planilha
                        </h5>
                        ...
                        <?php if ($_SESSION['CD_PERFIL'] == '6') { ?>
                            <form action="upload_pontuacao.php" method="post" enctype="multipart/form-data" style="display: flex; align-items: center; gap: 10px;">
                                <input type="hidden" name="destino" value="pontuacao">
        ...
        <div class="portfolio_four">
            <div class="tabs-content7">
                <div class="tabs-panel7">
                    ...
                    $SQL = "SELECT * FROM clifor order by ds_razao";
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <select class="tabs7-select" onchange="changeTab(this)">
                            ...
                            <?php foreach ($fornecedores as $codigo) {
                                $SQL = "SELECT ds_razao from clifor where cd_fornecedor = '$codigo'";
                                $RSS = mysql_query($SQL, $conexao);
                            ...
                            <div class="table-style tab-content tabela" style="display: block;">
                                <table class="table-list2">
                                    ...
                                    <tbody>
                                        ...
                                        $SQL =  "SELECT * FROM SIGA.SA5010 A5, SIGA.SB1010 B1 WHERE A5_FORNECE = '$codigo' AND A5_FILIAL IN ('09', '10') AND B1_COD = A5_PRODUTO AND B1_FILIAL = A5_FILIAL AND A5.D_E_L_E_T_ = ' ' AND B1.D_E_L_E_T_ = ' '";
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const tabelaBtn = document.getElementById('btnTabela') || document.querySelector('button:nth-child(2)'); 
            const gridBtn = document.getElementById('btnGrid') || document.querySelector('button:nth-child(3)');     
