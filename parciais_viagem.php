...
<body style="margin-top:-25px;">
    ...
    <div class="section_holdergrupos">
        <div class="container">
            <div class="one_full">
                <h3 style="text-align: center;">Parciais Moral Em Casa</h3>
                <!-- Abas com os grupos -->
                <div class="tabs-content7">
                    <h5>Meta mínima: 1 milhão e 500 mil pontos</h5>
                        ...
                        <table class="table-list2">
                            ...
                            while($RS = mysql_fetch_array($RSS)){
                                ...
                                while ($RS2 = mysql_fetch_array($RSS2)) {
                                    ...
                                    $grupo_usuario = $RS['cd_grupo']; 

                                    if (in_array($grupo_usuario, ['21', '22']) && in_array($cd_fornecedor, ['F00004', 'F00005'])) {
                                        continue;
                                    }
                            ...
                            ?>
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td style="background-color: <?= $info['total'] >= 1500000 ? " #61d661 " : " #ff8069" ?>">
                                        <?= number_format($info['total'],0,',','.') ?>
                                    </td>
                                    <td><?php if($x >= 1 && $x <= 10) echo 'Viagem' ?></td>
                                </tr>
                            <?php } ?>
                        </table>
                    </div>
