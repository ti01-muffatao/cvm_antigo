...
<!--- INICIO TABELA DE PONTOS *** OS DOIS GRUPOS CONCORREM ENTRE SI, NÃO HÁ DIVISÃO DE ESTADOS *** --->
  <div class="section_holdergrupos">
    <div class="container">
      <div class="one_full">
        <h3>Parciais Itens Foco Paraná</h3>
        <ul class="tabs7">
        ...
        <!-- INICIO NOVEMBRO -->
          ...
          <tr>
			...
			<?php $SQL = "select * from item_foco where cd_estado = 1 and cd_mes = 1 and cd_parcial = 1";
	...
	<font color="#C30009"><a onMouseOver="toolTip('<b>DATA DA ÚLTIMA PARCIAL')" onMouseOut="toolTip()" animatescroll();"><?php echo $RS["data"];}?></a></font></h5>
        ...
        <!-- INICIO DEZEMBRO -->
          ...
          <tr>
			...
			<?php $SQL = "select * from item_foco where cd_estado = 1 and cd_mes = 2 and cd_parcial = 2";
	...
	<font color="#C30009"><a onMouseOver="toolTip('<b>DATA DA ÚLTIMA PARCIAL')" onMouseOut="toolTip()" animatescroll();"><?php echo $RS["data"];}?></a></font></h5>
        ...
        <!-- INICIO JANEIRO -->
          ...
          <tr>
			...
			<?php $SQL = "select * from item_foco where cd_estado = 1 and cd_mes = 3 and cd_parcial = 3";
		  // $SQL .= " and cd_parcial = (select cd_parcial from item_foco order by cd_parcial desc limit 1) ";
	       $SQL .= " order by ds_usuario asc";
		   $RSS = mysql_query($SQL, $conexao);
		   while($RS = mysql_fetch_array($RSS)){
	...
	<font color="#C30009"><a onMouseOver="toolTip('<b>DATA DA ÚLTIMA PARCIAL')" onMouseOut="toolTip()" animatescroll();"><?php echo $RS["data"];}?></a></font></h5>
        ...
        <!-- INICIO FEVEREIRO -->
          ...
          <tr>
			...
			<?php $SQL = "select * from item_foco where cd_estado = 1 and cd_mes = 4 and cd_parcial = 4";
		   //$SQL .= " and cd_parcial = (select cd_parcial from item_foco order by cd_parcial desc limit 1) ";
	       $SQL .= " order by ds_usuario asc";
		   $RSS = mysql_query($SQL, $conexao);
		   while($RS = mysql_fetch_array($RSS)){
